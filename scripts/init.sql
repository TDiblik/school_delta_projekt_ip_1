...
insert into employees
    (first_name, last_name, salary, job_title_id, room_id)
    values
    ('Jiřina', 'Hamáčková', 32000.00, (select id from job_titles where name like 'ekonom(ka)'), (select id from rooms where name like 'Ekonomické')),
    ('Jindřich', 'Holzer', 22000.00, (select id from job_titles where name like 'techni(k/čka)'), (select id from rooms where name like 'Dílna')),
    ('Stanislav', 'Janovič', 22000.00, (select id from job_titles where name like 'techni(k/čka)'), (select id from rooms where name like 'Dílna')),
    ('Tomáš', 'Kalousek', 23000.00, (select id from job_titles where name like 'techni(k/čka)'), (select id from rooms where name like 'Dílna')),
    ('Alena', 'Krátká', 24000.00, (select id from job_titles where name like 'techni(k/čka)'), (select id from rooms where name like 'Dílna')),
    ('Stanislav', 'Lorenc', 14000.00, (select id from job_titles where name like 'skladní(k/ce)'), (select id from rooms where name like 'Sklad')),
    ('Martina', 'Marková', 14500.00, (select id from job_titles where name like 'skladní(k/ce)'), (select id from rooms where name like 'Sklad')),
    ('Alena', 'Netěsná', 42000.00, (select id from job_titles where name like 'ekonom(ka)'), (select id from rooms where name like 'Ekonomické')),
    ('František', 'Netěsný', 65000.00, (select id from job_titles where name like 'ředitel(ka)'), (select id from rooms where name like 'Ředitelna')),
    ('Milan', 'Steiner', 29000.00, (select id from job_titles where name like 'mistr(yně)'), (select id from rooms where name like 'Dílna'))
;
